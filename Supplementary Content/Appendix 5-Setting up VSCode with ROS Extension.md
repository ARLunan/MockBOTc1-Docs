...
Setting up **SSH Key**s on the Local Desktop Workstation Machine and Remote Rasapberry Pi.  

Installing the VSCode** Remote SSH** Extension Pack, that is actually a remote VSCode Server
